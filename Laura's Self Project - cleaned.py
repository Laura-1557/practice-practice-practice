def main():
    ...
    if name == "Laura":
        print("Hello Laura!")
        laura_age = int(input("How old are you? "))
        if laura_age < 40:
        ...
        if day_of_week == x.strftime("%A") == is_weekend:
            print("Nothing gets past you! Have a great weekend")
        elif day_of_week == x.strftime("%A") != is_weekend:
        ...
        number_of_computer_monitors = int(input("How many computer monitors do you have? "))
        if number_of_computer_monitors <= 2:
            print("That's not too bad.")
        elif 3 <= number_of_computer_monitors < 5:
            print("Are you sure you need that many?")
        elif number_of_computer_monitors >= 5:
            print("Are you NASA???")
